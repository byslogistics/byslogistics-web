...
| [src/data_files/](src/data_files/)                   | [constants.ts](src/data_files/constants.ts) (`SITE`, `CONTACT`, `LEGAL`, `FORMS`, `SEO`, `OG`, `partnersData`), [empresa.ts](src/data_files/empresa.ts) (`RESENA`, `SECTORES`) y `faqs.json`.                                          |
